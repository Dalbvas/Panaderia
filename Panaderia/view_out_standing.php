                                ...
                                <form name="deletefiles" action="delete.php" method="post">
                                    ...
                                    <table>
                                        ...
                                        if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {
                                            ...
                                            $SQL = "SELECT * FROM  transactions WHERE name LIKE '%" . $_POST['searchtxt'] . "%' ORDER BY id DESC";
                                        }
                                        ...
                                        if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {
                                            ...
                                            $query = "SELECT COUNT(*) as num FROM  transactions WHERE name LIKE '%" . $_POST['searchtxt'] . "%' ";
                                        }
                                        ...
                                        $sql = "SELECT * FROM transactions ORDER BY id DESC LIMIT $start, $limit  ";
                                        if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {

                                            $sql = "SELECT * FROM  transactions WHERE name LIKE '%" . $_POST['searchtxt'] . "%'   ORDER BY id DESC LIMIT $start, $limit";
                                        }
                                        ...
                                        $co = 0;
                                        $co1 = 0;
                                        $s = mysqli_query($db->connection, "select * from transactions");
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php
                                                    $quantity = $db->queryUniqueValue("SELECT quantity FROM transactions WHERE name='" . $row['name'] . "'");
                                                    echo $quantity;
                                                    ?></td>
