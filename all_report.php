...
if (!isset($_SESSION['username']) || $_SESSION['usertype'] != 'admin') { // if session variable "username" does not exist.
    ...
    if (isset($_GET['from_sales_purchase_date']) && isset($_GET['to_sales_purchase_date']) && $_GET['from_sales_purchase_date'] != '' && $_GET['to_sales_purchase_date'] != '') {
        ...
        <html>
        <head>
            <title>Reporte de Compra de Unidades</title>
            ...
            <tr>
                <td align="center">
                    ...
                    <table width="595" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td height="30" align="center"><strong>Reporte de Compra de Unidades </strong></td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <table width="300" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="150"><strong>Compra Total</strong></td>
                                                    <td width="150">
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="14%"><strong>Proveedor<br>
                                            </strong></td>
                                        <td width="14%"><strong>Stock</strong></td>
                                        <td width="11%"><strong>Cantidad</strong></td>
                                        <td width="8%"><strong>Tarifa</strong></td>
                                        <td width="11%"><strong>Apertura<br>
                                                Stock</strong></td>
                                        <td width="11%"><strong>Cierre<br>
                                                Stock</strong></td>
